...
const PageProject1 = () => {
  ...
  return (
    <div className={`PageProject1 ${theme}`}>
      ...
      <a href=" https://ragahad-najjar.github.io/Project_1/" target='_blank'> https://ragahad-najjar.github.io/Project_1/ </a>
      </div>
    </div>
  );
}
